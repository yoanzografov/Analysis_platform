...
export default function MarketSummaryWidgets({ stocks, activeFilter, onSetActiveFilter }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-4 flex flex-col justify-between transition-all duration-200 h-[305px] hover:shadow-md relative group">
        <div>
          ...
          >
            {top15Gainers.length > 0 ? (
              ...
              <p className="text-xs text-slate-400 font-mono py-8 text-center">Няма данни за печеливши акции.</p>
            )}
          </div>
        </div>
        ...
        <div className="border-t border-white/10/10 pt-2 text-[9px] font-mono text-white/60 uppercase tracking-tight flex items-center justify-between shrink-0">
          ...
          <span className="font-bold underline group-hover:text-[#00E676]">Топ Печеливши ({top15Gainers.length})</span>
        </div>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-4 flex flex-col justify-between transition-all duration-200 h-[305px] hover:shadow-md relative group">
        <div>
          ...
          >
            {top15Losers.length > 0 ? (
              ...
              <p className="text-xs text-slate-400 font-mono py-8 text-center">Няма данни за губещи акции.</p>
            )}
          </div>
        </div>
        ...
        <div className="border-t border-white/10/10 pt-2 text-[9px] font-mono text-white/60 uppercase tracking-tight flex items-center justify-between shrink-0">
          <span>Кликни на акция за филтър</span>
          <span className="font-bold underline group-hover:text-[#FF1744]">Топ Губещи ({top15Losers.length})</span>
        </div>
      </div>

      {/* 3. FEAR & GREED INDEX CONTAINER (HIGH-FIDELITY CNN BUSINESS COPIED STYLE) */}
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-4 flex flex-col justify-between relative md:col-span-1 h-[305px]">
        ...
        {loading ? (
          <div className="py-12 flex flex-col items-center justify-center space-y-2 flex-1">
            ...
            <span className="text-[10px] font-mono text-slate-400 uppercase">Зареждане на реално време от CNN...</span>
          </div>
        ) : (() => {
          ...
          return (
            <div className="flex flex-col flex-1 justify-between h-[215px] pt-1">
              ...
              <div className="border-t border-white/10/10 pt-1.5 text-[8px] font-mono text-slate-400 uppercase tracking-tight flex items-center justify-between shrink-0">
