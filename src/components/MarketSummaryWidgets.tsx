...
const INDICATORS_DATA: MarketIndicator[] = [
  ...
  {
    id: 11,
    title: '11. Consumer Sentiment (Потребителско настроение)',
    englishTitle: 'University of Michigan Consumer Sentiment Index',
    schedule: 'Два пъти месечно (предварителен и финален)',
    nextDateDesc: 'Индекс на потребителското настроение (UMich)',
    impact: 'MEDIUM',
    shortSummary: 'Измерва колко уверени са потребителите относно икономиката, личните си финанси и перспективите за следващите 12 месеца.',
    description: 'University of Michigan Consumer Sentiment Index (UMCSENT) измерва колко уверени и оптимистично настроени са американските потребители. Данните се публикуват два пъти месечно — предварителна и финална стойност. Индексът е ключов барометър за бъдещите потребителски разходи.',
    whyItMovesMarket: 'Оптимистичните потребители харчат повече пари и вземат кредити. Песимизмът предвещава забавяне на икономиката и по-слаби корпоративни приходи.',
    marketReaction: 'Висок индекс → позитивно за търговците на дребно, автопроизводителите и сектора на услугите.',
    tradingViewSymbol: 'FRED:UMCSENT',
    tradingViewUrl: 'https://www.tradingview.com/symbols/FRED-UMCSENT/',
    source: 'University of Michigan (Univ. of Michigan)',
