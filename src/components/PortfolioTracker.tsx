...
export default function PortfolioTracker({ 
  ...
  return (
    <div className="space-y-4 font-sans text-ink">
      ...
      {/* ======================================================================== */}
      {/* ROW 1: TOP 9-CARD METRIC GRID (Compact Symmetrical Equal-Height Layout)  */}
      {/* ======================================================================== */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 items-stretch">
        ...
        <div className="space-y-2.5 flex flex-col justify-between">
          ...
          <div className="bg-card/70 border border-border/80 border-l-4 border-l-indigo-400 rounded-xl p-2.5 shadow-md backdrop-blur-md flex flex-col justify-between min-h-[72px]">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-black uppercase text-indigo-300 tracking-wider flex items-center gap-1">
                <Sparkles className="w-3 h-3 text-indigo-400" />
                UNREALIZED P/L
              </span>
              <span className="text-[8.5px] font-extrabold text-indigo-300 bg-indigo-500/20 px-1.5 py-0.5 rounded border border-indigo-500/30 uppercase">
                Активни
              </span>
            </div>
            <div className="mt-1 grid grid-cols-2 gap-1.5 text-center">
              <div className="bg-emerald-500/15 border border-emerald-500/30 rounded-lg py-0.5 px-1.5 flex items-center justify-between">
                <span className="text-[8.5px] font-extrabold uppercase text-emerald-400/90">Profit</span>
                <span className="text-xs font-black text-emerald-400 font-mono">▲ {unrealizedProfitCount}</span>
              </div>
              <div className="bg-rose-500/15 border border-rose-500/30 rounded-lg py-0.5 px-1.5 flex items-center justify-between">
                <span className="text-[8.5px] font-extrabold uppercase text-rose-400/90">Loss</span>
                <span className="text-xs font-black text-rose-400 font-mono">▼ {unrealizedLossCount}</span>
              </div>
            </div>
          </div>

          {/* Card 5: REALIZED PROFIT/LOSS */}
          <div className="bg-card/70 border border-border/80 border-l-4 border-l-purple-400 rounded-xl p-2.5 shadow-md backdrop-blur-md flex flex-col justify-between min-h-[72px]">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-black uppercase text-purple-300 tracking-wider flex items-center gap-1">
                <History className="w-3 h-3 text-purple-400" />
                REALIZED P/L
              </span>
              <span className="text-[8.5px] font-extrabold text-purple-300 bg-purple-500/20 px-1.5 py-0.5 rounded border border-purple-500/30 uppercase">
                История
              </span>
            </div>
            <div className="mt-1 grid grid-cols-2 gap-1.5 text-center">
              <div className="bg-emerald-500/15 border border-emerald-500/30 rounded-lg py-0.5 px-1.5 flex items-center justify-between">
                <span className="text-[8.5px] font-extrabold uppercase text-emerald-400/90">Profit</span>
                <span className="text-xs font-black text-emerald-400 font-mono">▲ {realizedProfitCount}</span>
              </div>
              <div className="bg-rose-500/15 border border-rose-500/30 rounded-lg py-0.5 px-1.5 flex items-center justify-between">
                <span className="text-[8.5px] font-extrabold uppercase text-rose-400/90">Loss</span>
                <span className="text-xs font-black text-rose-400 font-mono">▼ {realizedLossCount}</span>
              </div>
            </div>
          </div>

          {/* Card 6: PROFIT/LOSS */}
          <div className="bg-card/70 border border-border/80 border-l-4 border-l-amber-400 rounded-xl p-2.5 shadow-md backdrop-blur-md flex flex-col justify-between min-h-[72px]">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-black uppercase text-amber-300 tracking-wider flex items-center gap-1">
                <Flame className="w-3 h-3 text-amber-400" />
                PROFIT / LOSS
              </span>
              <span className="text-[8.5px] font-extrabold text-amber-300 bg-amber-500/20 px-1.5 py-0.5 rounded border border-amber-500/30 uppercase">
                Общо
              </span>
            </div>
            <div className="mt-1 grid grid-cols-2 gap-1.5 text-center">
              <div className="bg-emerald-500/15 border border-emerald-500/30 rounded-lg py-0.5 px-1.5 flex items-center justify-between">
                <span className="text-[8.5px] font-extrabold uppercase text-emerald-400/90">Profit</span>
                <span className="text-xs font-black text-emerald-400 font-mono">▲ {unrealizedProfitCount + realizedProfitCount}</span>
              </div>
              <div className="bg-rose-500/15 border border-rose-500/30 rounded-lg py-0.5 px-1.5 flex items-center justify-between">
                <span className="text-[8.5px] font-extrabold uppercase text-rose-400/90">Loss</span>
                <span className="text-xs font-black text-rose-400 font-mono">▼ {unrealizedLossCount + realizedLossCount}</span>
              </div>
            </div>
          </div>
        </div>
