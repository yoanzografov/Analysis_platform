...
export const EXACT_SHEET_ROWS: SheetRowDefinition[] = [
  ...
  { rowNum: 21, label: 'Gross Margin', defaultVal: '', cellType: 'yellow-input', formulaStr: '=(Gross Profit / Total Revenue) x 100 (%)', flagRules: { green: '40%+', yellow: '30% - 40%', red: '< 30%' }, note: 'Gross Margin = (Gross Profit / Total Revenue) x 100 (%)\nПоказва ни какъв процент от оборота представлява брутната печалба. Колкото повече, толкова по-добре (🟢 40%+ | 🟡 30%-40% | 🔴 < 30%).' },
