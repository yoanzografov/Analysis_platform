          ...
          <div className="bg-bg/40 p-4 rounded-2xl border border-border/60 space-y-3.5 text-xs">
            ...
            <div className="flex items-center gap-2 pt-2">
              <button
                type="button"
                onClick={handleClear}
                className="px-4 py-2 rounded-xl bg-card hover:bg-card-hover border border-border text-ink-muted hover:text-ink font-extrabold text-xs flex items-center justify-center gap-1.5 cursor-pointer transition-all shrink-0"
              >
          ...
          <div className="flex flex-col justify-between space-y-4">
            ...
            <div className="bg-bg/60 rounded-2xl border border-border/60 divide-y divide-border/40 text-xs font-sans relative">
              ...
              <div className="flex items-center justify-between px-3.5 py-2.5 relative">
                ...
                >
                  <span className="font-bold text-ink-faint group-hover/cagr:text-emerald-400 transition-colors border-b border-dashed border-ink-faint/50">
                    Годишен ROI (Annualized ROI %):
                  </span>
                  <span className="px-1.5 py-0.5 rounded text-[10px] font-black bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 tracking-tight">
                    CAGR
                  </span>
                  <Info className="w-3.5 h-3.5 text-emerald-400/80 group-hover/cagr:text-emerald-400 transition-colors" />

                  {/* Floating Tooltip / Comment Popup in Platform Theme */}
                  {showCagrTooltip && (
                    <div className="absolute left-0 bottom-full mb-2 w-72 sm:w-84 p-3.5 bg-card border border-border rounded-2xl shadow-2xl z-[1000005] text-xs animate-in fade-in zoom-in-95 duration-150">
                      <div className="flex items-center justify-between pb-1.5 border-b border-border/40">
                        ...
                        <span className="text-[9px] bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 font-extrabold px-1.5 py-0.5 rounded">
                          Коментар
                        </span>
                      </div>
                      <div className="pt-2 space-y-1.5 text-[11px] leading-relaxed text-ink font-sans">
                        <p>
                          <strong className="text-emerald-400">Annualized ROI е еквивалентен на CAGR</strong> — съставният годишен темп на растеж на вашата инвестиция със сложна лихва.
                        </p>
                        ...
                        <div className="mt-1 p-2 rounded-xl bg-bg border border-border text-emerald-400 font-mono text-[10px] space-y-0.5">
                          <div className="font-bold text-ink">Формула:</div>
                          <div>CAGR = (Крайна сума / Начална сума)^(1 / Години) - 1</div>
                        </div>
                      </div>
                      {/* Triangle tail */}
                      <div className="absolute top-full left-8 -mt-1 w-2.5 h-2.5 bg-card border-r border-b border-border transform rotate-45" />
                    </div>
                  )}
                </div>
