...
export default function StockTable({ stocks, onUpdateStock, onDeleteStock, onSelectStockForAi, onAddStock, activeFilter, onSetActiveFilter }: Props) {
  ...
  return (
    <div className="w-full bg-[#1e222d] border border-[#2a2e39] rounded-none overflow-hidden shadow-xs">
      
      {/* Search & Filters */}
      <div className="p-3 bg-[#131722] border-b border-[#2a2e39] flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-1">
          <button
            ...
            className="px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase transition-all rounded-none border border-[#2962ff]/50 bg-[#2962ff] hover:bg-[#1e53e5] text-[#d1d4dc] flex items-center gap-1 cursor-pointer shrink-0"
            title="Добави нова акция в таблицата"
          >
            <Plus className="w-3 h-3 text-[#d1d4dc]" />
            Добавяне
          </button>
          <button
            ...
            className={`px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase transition-all rounded-none border ${
              activeFilter.type === 'all' ? 'bg-[#131722] text-[#d1d4dc] border-black' : 'bg-[#1e222d] text-[#d1d4dc] border-[#363a45] hover:text-[#d1d4dc] hover:bg-[#2a2e39]/50'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase transition-all rounded-none border ${
              activeFilter.type === 'buySell' && activeFilter.value === 'BUY' ? 'bg-[#26a69a] text-[#d1d4dc] border-[#26a69a]/50' : 'bg-[#1e222d] text-[#26a69a] border-[#26a69a]/30 hover:bg-[#26a69a]/10'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase transition-all rounded-none border ${
              activeFilter.type === 'buySell' && activeFilter.value === 'SELL' ? 'bg-[#ef5350] text-[#d1d4dc] border-[#ef5350]/50' : 'bg-[#1e222d] text-[#ef5350] border-[#ef5350]/30 hover:bg-[#ef5350]/10'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase transition-all rounded-none border ${
              activeFilter.type === 'buySell' && activeFilter.value === 'ДРУГИ' ? 'bg-gray-600 text-[#d1d4dc] border-gray-700' : 'bg-[#1e222d] text-[#b2b5be] border-[#363a45] hover:bg-[#2a2e39]'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase transition-all rounded-none border ${
              activeFilter.type === 'signal' && activeFilter.value === 'hold' ? 'bg-amber-700 text-[#d1d4dc] border-amber-500/50' : 'bg-[#1e222d] text-amber-400 border-amber-500/40 hover:bg-[#b06000]/10'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase transition-all rounded-none border ${
              activeFilter.type === 'watch' ? 'bg-indigo-500 text-[#d1d4dc] border-indigo-800' : 'bg-[#1e222d] text-indigo-800 border-indigo-400/40 hover:bg-indigo-500/10'
            }`}
          >
          ...
          {activeFilter.type === 'signal' && activeFilter.value === 'buy' && (
            <span className="px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase rounded-none border bg-[#26a69a] text-[#d1d4dc] border-[#26a69a]/50 flex items-center gap-1 shrink-0">
          ...
          {activeFilter.type === 'signal' && activeFilter.value === 'sell' && (
            <span className="px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase rounded-none border bg-[#ef5350] text-[#d1d4dc] border-[#ef5350]/50 flex items-center gap-1 shrink-0">
          ...
          {activeFilter.type === 'ticker' && (
            <span className="px-2.5 py-1 text-[10px] font-mono font-extrabold uppercase rounded-none border bg-indigo-600 text-[#d1d4dc] border-indigo-950 flex items-center gap-1 shrink-0">
        ...
        <div className="relative w-full md:w-64">
          <Search className="absolute left-2.5 top-2 w-3.5 h-3.5 text-[#787b86]" />
          <input
            type="text"
            placeholder="Търсене по тикер или име..."
            value={search}
            onChange={e => { setSearch(e.target.value); setCurrentPage(1); }}
            className="w-full bg-[#1e222d] border border-[#2a2e39] rounded-none pl-8 pr-3 py-1 text-xs text-[#d1d4dc] focus:outline-none focus:border-[#2a2e39] font-mono"
          />
        </div>
      </div>

      {/* Main Grid Responsive Table with exactly 20 columns and scrollbar view */}
      <div className="w-full max-h-[520px] overflow-y-auto overflow-x-auto border-b border-[#2a2e39]/15">
        <table className="w-full text-left border-collapse min-w-[1900px] table-fixed">
          ...
          <thead className="sticky top-0 z-20 bg-[#1e222d]">
            <tr className="bg-[#1e222d] text-[#d1d4dc]/90 border-b-2 border-[#2a2e39] text-[10px] uppercase font-mono tracking-wider select-none">
              <th className="py-2.5 px-3 whitespace-nowrap">Watch</th>
              <th className="py-2.5 px-3 cursor-pointer hover:bg-[#2a2e39]/50 whitespace-nowrap" onClick={() => handleSort('ticker')}>
              ...
              <th className="py-2.5 px-3 text-right cursor-pointer hover:bg-[#2a2e39]/50 whitespace-nowrap" onClick={() => handleSort('dailyChangePct')}>
                Daily Change %{sortField === 'dailyChangePct' ? (sortOrder === 'asc' ? ' ▲' : ' ▼') : ''}
              </th>
              <th className="py-2.5 px-3 text-right cursor-pointer hover:bg-[#2a2e39]/50 whitespace-nowrap" onClick={() => handleSort('currentPrice')}>
                Current Price{sortField === 'currentPrice' ? (sortOrder === 'asc' ? ' ▲' : ' ▼') : ''}
              </th>
              <th className="py-2.5 px-3 text-right cursor-pointer hover:bg-[#2a2e39]/50 whitespace-nowrap" onClick={() => handleSort('fairPrice')}>
                Fair Price{sortField === 'fairPrice' ? (sortOrder === 'asc' ? ' ▲' : ' ▼') : ''}
              </th>
              <th className="py-2.5 px-3 text-right cursor-pointer hover:bg-[#2a2e39]/50 whitespace-nowrap" onClick={() => handleSort('difference')}>
                Difference{sortField === 'difference' ? (sortOrder === 'asc' ? ' ▲' : ' ▼') : ''}
              </th>
              <th className="py-2.5 px-3 text-center whitespace-nowrap">BUY/SELL</th>
              <th className="py-2.5 px-3 text-right cursor-pointer hover:bg-[#2a2e39]/50 whitespace-nowrap" onClick={() => handleSort('marketCap')}>
          ...
          <tbody className="divide-y divide-[#2a2e39] font-mono text-[11px] text-[#d1d4dc]">
            {pageStocks.map(stock => {
              ...
              return (
                <tr
                  key={stock.ticker}
                  className={`hover:bg-[#131722]/20 transition-colors duration-75 group ${
                    isEditing ? 'bg-[#1e222d]/10' : ''
                  }`}
                ...
                >
                  ...
                  <td className="py-2 px-3 font-sans overflow-hidden text-ellipsis whitespace-nowrap">
                    {isEditing ? (
                      <select
                        ...
                        className="bg-[#1e222d] text-[11px] text-[#d1d4dc] border border-[#2a2e39] p-0.5 rounded-none font-mono w-full"
                      >
                        <option value="">-</option>
                      ...
                      <span className="bg-amber-500/10 text-amber-400 font-extrabold px-1 border border-amber-400/30 text-[8.5px] uppercase rounded-none">
                        Attn
                      </span>
                    ) : stock.watch === 'Watch' ? (
                      <span className="bg-[#2962ff]/10 text-[#2962ff] font-extrabold px-1 border border-[#2962ff]/30 text-[8.5px] uppercase rounded-none">
                        Watch
                      </span>
                    ) : stock.watch === 'Sell' ? (
                      <span className="bg-[#ef5350]/10 text-[#ef5350] font-extrabold px-1 border border-[#ef5350]/20 text-[8.5px] uppercase rounded-none">
                        Sell
                      </span>
                    ) : stock.watch === 'Buy' ? (
                      <span className="bg-[#26a69a]/10 text-[#26a69a] font-extrabold px-1 border border-[#26a69a]/20 text-[8.5px] uppercase rounded-none">
                        Buy
                      </span>
                    ) : stock.watch === 'Interesting' ? (
                      <span className="bg-purple-500/10 text-purple-400 font-extrabold px-1 border border-purple-400/30 text-[8.5px] uppercase rounded-none">
                        Interesting
                      </span>
                    ) : stock.watch === 'Not interesting' ? (
                      <span className="bg-[#2a2e39] text-[#b2b5be] font-bold px-1 border border-[#2a2e39] text-[8.5px] uppercase rounded-none">
                        Not interesting
                      </span>
                    ) : (
                  ...
                  {/* 2. TICKER */}
                  <td className="py-2 px-3 font-extrabold text-[#d1d4dc] overflow-hidden text-ellipsis">
                    {stock.ticker}
                  </td>

                  {/* 3. COMPANY NAME */}
                  <td className="py-2 px-3 text-[#d1d4dc] font-sans font-medium hover:text-[#d1d4dc] transition-colors overflow-hidden text-ellipsis whitespace-nowrap">
                    {isEditing ? (
                      <input
                        type="text"
                        value={editCompanyName}
                        onChange={e => setEditCompanyName(e.target.value)}
                        className="w-full bg-[#1e222d] text-left font-sans text-[11px] text-[#d1d4dc] border border-[#2a2e39] px-1 py-0.5 rounded-none focus:outline-none"
                      />
                    ) : (
                      <div className="flex items-center justify-between gap-1 group/cell">
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 group-hover/cell:opacity-100 text-[#787b86] hover:text-[#d1d4dc] transition-opacity p-0.5 shrink-0"
                  ...
                  <td className="py-2 px-3 text-center">
                    <button
                      ...
                      className="inline-flex items-center justify-center p-1 rounded-none hover:bg-stone-100 border border-transparent hover:border-[#2a2e39] transition-all cursor-pointer"
                  ...
                  {/* 5. DATE */}
                  <td className="py-2 px-3 text-[#787b86] text-[10px] overflow-hidden text-ellipsis whitespace-nowrap">
                    {isEditing ? (
                      <input
                        type="date"
                        value={editDate}
                        onChange={e => setEditDate(e.target.value)}
                        className="w-full bg-[#1e222d] text-left font-mono text-[11px] text-[#d1d4dc] border border-[#2a2e39] px-1 py-0.5 rounded-none focus:outline-none cursor-pointer"
                      />
                    ) : (
                      <div className="flex items-center justify-between gap-1 group/cell">
                  ...
                  <td className="py-2 px-3 text-right text-[#787b86]">
                    {isEditing ? (
                      <input
                        ...
                        className="w-full bg-[#1e222d] text-right font-mono text-xs text-[#d1d4dc] border border-[#2a2e39] p-0.5 rounded-none focus:outline-none"
                        placeholder="-"
                      />
                    ) : (
                  ...
                  <td className="py-2 px-3 text-right font-extrabold">
                    <span
                      className={`flex items-center justify-end gap-0.5 ${
                        isPositiveChange ? 'text-[#26a69a]' : 'text-red-750'
                      }`}
                    >
                      {isPositiveChange ? (
                  ...
                  <td className="py-2 px-3 text-right font-extrabold text-black bg-stone-50">
                    {isEditing ? (
                      <input
                        ...
                        className="w-full bg-[#1e222d] text-right font-bold text-[#d1d4dc] border border-[#2a2e39] p-0.5 rounded-none font-mono text-[11px] focus:outline-none"
                      />
                    ) : (
                  ...
                  {/* 9. FAIR PRICE */}
                  <td className="py-2 px-3 text-right font-extrabold text-[#26a69a] bg-emerald-50/20">
                    {isEditing ? (
                      <input
                        type="text"
                        value={editFair}
                      ...
                      <div className="flex items-center justify-end gap-1 group/cell">
                        ...
                        <button
                          onClick={() => startInlineEdit(stock)}
                          className="opacity-0 group-hover:opacity-100 group-hover/cell:opacity-100 text-[#26a69a] hover:text-[#d1d4dc] transition-opacity p-0.5 shrink-0"
                  ...
                  {/* 10. DIFFERENCE */}
                  <td className={`py-2 px-3 text-right font-extrabold ${isUndervalued ? 'text-[#26a69a]' : 'text-red-750'}`}>
                  ...
                  <td className="py-2 px-3 text-center">
                    {stock.buySell === 'BUY' ? (
                      <span className="bg-emerald-150 text-[#26a69a] border border-emerald-500 px-1.5 py-0.5 text-[8.5px] font-extrabold uppercase tracking-wide">
                        BUY
                      </span>
                    ) : stock.buySell === 'SELL' ? (
                      <span className="bg-[#c5221f]/10 text-[#ef5350] border border-[#c5221f]/40 px-1.5 py-0.5 text-[8.5px] font-extrabold uppercase tracking-wide">
                        SELL
                      </span>
                    ) : (
                      <span className="bg-[#D9D8D5] text-[#d1d4dc] border border-[#2a2e39]/30 px-1.5 py-0.5 text-[8.5px] font-bold uppercase">
                        {stock.buySell}
                      </span>
                    )}
                  </td>
                  ...
                  <td className="py-2 px-3 text-right text-[#b2b5be] font-mono bg-stone-50">
                  ...
                  {/* 16. DIVIDEND */}
                  <td className="py-2 px-3 text-[#d1d4dc] whitespace-nowrap">
                    {isEditing ? (
                      <input
                        type="text"
                        value={editDividend}
                        onChange={e => setEditDividend(e.target.value)}
                        className="w-full bg-[#1e222d] text-left font-mono text-[11px] text-[#d1d4dc] border border-[#2a2e39] px-1 py-0.5 rounded-none focus:outline-none"
                      />
                    ) : (
                      <div className="flex items-center justify-between gap-1 group/cell">
                  ...
                  {/* 17. SIGNAL */}
                  <td className="py-2 px-3 text-[#d1d4dc] overflow-hidden text-ellipsis whitespace-nowrap">
                    {isEditing ? (
                      <input
                        type="text"
                        value={editSignal}
                    ...
                    {isEditing ? (
                      showConfirmFair === stock.ticker ? (
                        <div className="flex flex-col items-center gap-1 bg-amber-50 border border-amber-200 p-1.5 rounded-none z-10 shrink-0 min-w-[130px]">
                          ...
                          <div className="flex items-center gap-1.5 justify-center mt-1">
                            <button
                              ...
                              className="px-2 py-0.5 text-[9px] font-bold bg-amber-600 hover:bg-amber-700 text-[#d1d4dc] rounded-none border border-amber-750 cursor-pointer"
                            >
                              Да
                            </button>
                            <button
                              onClick={() => executeSave(stock.ticker, false)}
                              className="px-2 py-0.5 text-[9px] font-bold bg-stone-500 hover:bg-stone-600 text-[#d1d4dc] rounded-none border border-stone-600 cursor-pointer"
                            >
                              Не
                            </button>
                          </div>
                        ...
                        <div className="flex items-center justify-center gap-1 shrink-0">
                          <button
                            ...
                            className="p-1 rounded-none bg-emerald-700 text-[#d1d4dc] hover:bg-[#26a69a] duration-100 border border-emerald-800 cursor-pointer"
                            title="Запази"
                          >
                          ...
                          <button
                            ...
                            className="p-1 rounded-none bg-red-700 text-[#d1d4dc] hover:bg-red-800 duration-100 border border-red-850 cursor-pointer"
                            title="Отказ"
                          >
                            <X className="w-3 h-3" />
                          </button>
                      ...
                      <div className="flex items-center justify-center gap-1.5 shrink-0">
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-[9px] font-bold py-0.5 px-2.5 border border-[#2a2e39] bg-[#131722] hover:bg-[#26a69a] hover:text-[#d1d4dc] hover:border-emerald-900 text-[#d1d4dc] transition-all rounded-none"
                          title="Прочетете най-новите достоверни новини за компанията"
                        >
                          <Newspaper className="w-2.5 h-2.5 text-[#26a69a] group-hover:text-[#d1d4dc]" />
                          <span>Новини</span>
                        </button>
                        <button
                          onClick={() => onDeleteStock(stock.ticker)}
                          className="p-1 rounded-none border border-transparent hover:border-[#ef5350]/20 hover:bg-red-50 text-gray-550 hover:text-red-700 transition-all cursor-pointer"
      ...
      {/* table status footer */}
      <div className="p-3 bg-[#131722] border-t border-[#2a2e39] flex flex-col sm:flex-row sm:items-center justify-between font-mono text-[11px] text-[#d1d4dc]/90 gap-1.5">
        <span>
          Показване на всички <span className="font-extrabold underline">{sortedStocks.length}</span> намерени акции
        </span>
        <span className="text-[10px] text-[#787b86] italic">
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 bg-[#131722]/60 z-50 flex items-center justify-center p-4 backdrop-blur-xs">
          <div className="bg-[#131722] border-2 border-[#2a2e39] rounded-none shadow-[6px_6px_0px_0px_rgba(20,20,20,1)] w-full max-w-md p-5 relative font-mono text-xs">
            
            {/* Header */}
            <div className="flex items-center justify-between border-b-2 border-[#2a2e39] pb-2.5 mb-4">
              <h3 className="text-xs uppercase font-extrabold text-[#d1d4dc] flex items-center gap-1.5">
                <Plus className="w-4 h-4 text-blue-800 animate-pulse" />
                <span>Добави нов актив</span>
              </h3>
              <button 
                onClick={() => setIsAddModalOpen(false)} 
                className="text-[#787b86] hover:text-[#d1d4dc] p-0.5 cursor-pointer"
                type="button"
              >
                <X className="w-4 h-4" />
              </button>
            ...
            <form onSubmit={handleAddNewStockSubmit} className="space-y-3.5">
              ...
              <div className="grid grid-cols-2 gap-3.5">
                {/* Ticker */}
                <div>
                  <label className="block text-[10px] font-bold uppercase text-[#d1d4dc]/90 mb-1">
                    Тикер / Ticker *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-[#1e222d] border border-[#2a2e39] rounded-none font-bold uppercase p-2 focus:outline-none focus:border-blue-900"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#1e222d] border border-[#2a2e39] rounded-none p-2 focus:outline-none focus:border-blue-900"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#1e222d] border border-[#2a2e39] rounded-none p-2 focus:outline-none focus:border-blue-900 cursor-pointer"
                />
              </div>
              ...
              <div className="text-[10.5px] text-[#787b86] italic pt-1 text-right leading-tight">
                * Разликата, Сигналът и BUY/SELL се изчисляват автоматично на база цена и качество.
              </div>

              {/* Footer Buttons */}
              <div className="flex items-center justify-end gap-2 border-t border-[#2a2e39]/15 pt-3.5 mt-4">
                <button
                  type="button"
                  onClick={() => setIsAddModalOpen(false)}
                  className="px-3.5 py-2 font-bold uppercase bg-[#1e222d] hover:bg-[#2a2e39]/50 border border-[#2a2e39] rounded-none text-[#d1d4dc] cursor-pointer"
                >
                  Отказ
                </button>
                <button
                  type="submit"
                  className="px-4 py-2 font-extrabold uppercase bg-emerald-700 hover:bg-[#26a69a] border border-[#26a69a]/50 text-[#d1d4dc] rounded-none shadow-sm cursor-pointer"
                >
                  Запази & Добави
                </button>
              </div>
