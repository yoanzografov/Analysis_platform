                  ...
                  >
                      ...
                      <div className="shrink-0">
                        {isTriggered ? (
                          ...
                          >
                            ...
                            <Edit3 className="w-3 h-3 text-indigo-400 opacity-70 group-hover/cond:opacity-100" />
                          </button>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-2 pt-1 sm:pt-0 border-t sm:border-t-0 border-border/30 w-full sm:w-auto shrink-0">
                      ...
                      <button
                        ...
                        className="h-6.5 px-2.5 rounded-lg border border-indigo-500/40 bg-indigo-500/15 hover:bg-indigo-500 text-indigo-300 hover:text-white flex items-center gap-1 text-[11px] font-black transition-all cursor-pointer shrink-0 shadow-2xs group/btn"
                        title="Редактирай сигнала за известие"
                      >
                        <Edit3 className="w-3.5 h-3.5 text-indigo-400 group-hover/btn:text-white" />
                        <span>Редакция</span>
                      </button>
