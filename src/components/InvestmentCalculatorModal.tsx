...
import { Calculator, X, TrendingUp, DollarSign, Calendar, RefreshCw, ExternalLink } from 'lucide-react';
...
export default function InvestmentCalculatorModal({ isOpen, onClose, baseCurrency = 'USD' }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[1000000] flex items-center justify-center p-4 bg-bg/80 backdrop-blur-md font-sans">
        ...
        <div className="flex items-center justify-between border-b border-border/40 pb-3.5">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-2.5 py-1 text-[10px] font-bold text-indigo-400 hover:text-indigo-300 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/30 rounded-lg transition-all cursor-pointer flex items-center gap-1 whitespace-nowrap"
